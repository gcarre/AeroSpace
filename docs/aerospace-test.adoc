...
%{window-parent-container-layout}:: String. The layout (`dwindle`, `v_tiles`, `h_tiles`, `v_accordion`, `h_accordion`, `floating`) of the window's parent container.
...
%{workspace-root-container-layout}:: String. The layout (`dwindle`, `v_tiles`, `h_tiles`, `v_accordion`, `h_accordion`) of the workspace the window belongs to.
